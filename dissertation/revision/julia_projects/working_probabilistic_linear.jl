...
# ╔═╡ 5f86eb49-a783-42a9-a856-70f768f83e6f
begin
	using Flux
	using Distributions
	using Plots
...
# ╔═╡ b8e7bfb8-0c02-40c8-a023-e542b4b4e447
md"""
## No Uncertainty
"""

# ╔═╡ bf12c320-fe1c-11ec-3885-553b76daeccf
begin
	# Generate data
	out = 1
	input = 1
	...
	function varianceSoftplus(myσ)
		return 1e-3 + softplus(0.05 * myσ)
	end

	function loss(x, y)
		ŷ = model(x)
		ŷGauss = Normal(ŷ[1], 1)
		-logpdf(ŷGauss, y[1])
	end
...
# ╔═╡ 28c7164f-9726-4072-9e39-638f5a9610e2
W

# ╔═╡ 47497239-4d18-4290-8062-80e0030f0741
W_truth

# ╔═╡ 3e42eba7-280a-479b-b09c-08085476bff8
b

# ╔═╡ a82634aa-c565-44d9-a0ea-c7fa5b896e37
b_truth
